...
FSUB_IMG = (environ.get('FSUB_IMG', 'https://files.catbox.moe/9e29rz.jpg https://files.catbox.moe/zw41yz.jpg')).split() 
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002476567751'))  
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003351490855') 
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/MRN_Tutorial/1814")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/MRN_Tutorial/1805")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/MRN_Tutorial/1814")

SHORTENER_API = environ.get("SHORTENER_API", "1b8e94e97189da28b35fcab06c0850bd92569751")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+lTO1v9u3v4FhODNl') 
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "True")), True)
IMDB = is_enabled((environ.get('IMDB', "False")), False)
AUTO_FFILTER = is_enabled((environ.get('AUTO_FFILTER', "True")), True)
AUTO_DELETE = is_enabled((environ.get('AUTO_DELETE', "True")), True)
AUTO_DELETE_TIME = int(environ.get("AUTO_DELETE_TIME", "1500"))  
...
URL = "https://filterbot-mrniofficialx.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else "https://filterbot-mrniofficialx.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://filterbot-mrniofficialx.koyeb.app/".format(FQDN)
else:
    URL = "https://filterbot-mrniofficialx.koyeb.app/".format(FQDN)
